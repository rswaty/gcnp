...
* The area is dominated by shrubland vegetation cover and types, such as the Colorado Plateau Mixed Bedrock Canyon and Tableland.
* The type that LANDFIRE mapped as most prevelant, the Colorado Plateau Mixed Bedrock Canyon and Tableland is noted to have relatively sparse vegetation, and a high rate of endimeic forbs.  See the NatureServe description [here](https://explorer.natureserve.org/Taxon/ELEMENT_GLOBAL.2.722907/Colorado_Plateau_Mixed_Bedrock_Canyon_and_Tableland).
* The most dominant treed vegetation type mapped is the Colorado Plateau Pinyon-Juniper Woodland. 
